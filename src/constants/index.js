...
export const JWT = {
  saltRounds: 7, // GOWORKR
  jwtSecret: "yo, it's a go fucking work -r hidden fucking secret|| Why you wanna know this shit!!!! Fuck You If You Ever Get Here", // BITCH
...
export { STATUS_MSG } from './status-message';
