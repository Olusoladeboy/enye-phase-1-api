...
var STATUS_MSG = {
  ERROR: {
    ...
    INVALID_PARTNER_ID: {
      statusCode: 400,
      customMessage: "Invalid PmtPartner Id Provided.",
      type: "INVALID_PARTNER_ID"
    },
    PARTNER_ALREADY_ASSIGNED: {
      statusCode: 400,
      customMessage: "PmtPartner already assigned to job.",
  ...
  SUCCESS: {
    ...
    PARTNER_REQUEST_DECLINED: {
      statusCode: 201,
      customMessage: "PmtPartner Request declined successfully.",
    ...
    PARTNER_REGISTERED: {
      statusCode: 201,
      customMessage: "PmtPartner registered successfully.",
      type: "PARTNER_REGISTERED"
    },
    PARTNER_CREATED: {
      statusCode: 201,
      customMessage: "PmtPartner added successfully.",
    ...
    PARTNER_UPDATED: {
      statusCode: 201,
      customMessage: "PmtPartner data updated successfully.",
