...
router.post('/user/login', _controller.loginHandler);
/**
...
router.put('/user/verify/:recordId', [_authorization.checkAuth, _authorization.isValidUser], _controller.updateVerificationStatusHandler);
var _default = router;
