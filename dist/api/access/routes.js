...
router.get("/accesses", [_middleware.checkAuth, _middleware.isValidUser], _controller.fetchRecord);
/**
...
router.post("/accesses", [_middleware.checkAuth, _middleware.isValidUser], _controller.createRecord);
/**
...
router["delete"]("/accesses/:recordId", [_middleware.checkAuth, _middleware.isValidUser], _controller.deleteRecord);
var _default = router;
